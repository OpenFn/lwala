...
combine(function(state){
if(dataValue("form.Person.Updated_Total_Number_of_Members")(state)!==null && dataValue("form.Person.Updated_Total_Household_Members")(state)!==undefined){
  upsert("Household__c","CommCare_Code__c",fields(
      field("CommCare_Code__c",dataValue("form.case.@case_id")),
      field("Total_household_people__c", dataValue("Updated_Total_Number_of_Members"))
  ))}
}),
