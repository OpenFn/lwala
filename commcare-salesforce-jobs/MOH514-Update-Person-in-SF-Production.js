    ...
    return upsert(
      ...
      fields(
        ...
        field('Client_provided_with_FP__c', state => {
          var choice = dataValue('form.TT5.Mother_Information.was_the_woman_15-49yrs_provided_with_family_planning_commodities_by_chv')(state);
        ...
        field('Child_fast_breathing_referral_date__c', dataValue('form.psbi.Fast_breathing_followup_date__c')),
        field('Fast_breathing_followup_date__c', dataValue('form.psbi.when_did_you_follow_up_for_fast_breathing')),
