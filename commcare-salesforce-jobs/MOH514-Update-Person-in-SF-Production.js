  ...
  return execute(
    fn(state => {
      if (
        ...
        const clinical =
          state.data.form.TT5.Child_Information.Clinical_Services;
      ...
      state.cleanChoice = function (state, choice) {
        if (choice) {
          return (
            choice.charAt(0).toUpperCase() + choice.slice(1).replace('_', ' ')
          );
        } else {
          return '';
        }
    ...
    fn(state => {
      if (
        ...
        return upsert(
          ...
          fields(
            ...
            field(
              'Telephone__c',
              dataValue('form.Status.updated_phone_number')
            ),
            ...
            field('Purpose_of_referral__c', state => {
              var purpose =
                ...
                dataValue(
                  'form.treatment_and_tracking.CCMM.Purpose_of_Referral'
                )(state) ||
            ...
            field('Reason_for_not_taking_a_pregnancy_test__c', state => {
              var reason = dataValue(
                'form.TT5.Mother_Information.No_Preg_Test'
              )(state);
              return reason !== undefined
                ? reason.toString().replace(/_/g, ' ')
                : null;
            ...
            field('Child_Status__c', state => {
              ...
              if (status !== undefined && status !== 'Born' && status !== 'Yes' && rt === 'Unborn') {
                status = 'Unborn';
            ...
            field(
              ...
              dataValue(
                'form.TT5.Child_Information.CCMM.Fever-Follow-Up_By_Date'
              )
            ),
            field(
              'Malaria_Facility__c',
              dataValue(
                'form.TT5.Child_Information.CCMM.malaria_referral_facility'
              )
            ),
            field(
              'Malaria_Referral__c',
            ...
            field(
              ...
              dataValue(
                'form.treatment_and_tracking.mild_symptoms_check_diarrhea'
              )
            ),
            field(
            ...
            field('Place_of_Delivery__c', state => {
              var facility = dataValue(
                'form.TT5.Child_Information.Delivery_Type'
              )(state);
            ...
            field('Pregnant__c', state => {
              var preg = dataValue('form.TT5.Mother_Information.Pregnant')(
                state
              );
            ...
            field(
              'Mother_ANC_Referral__c',
              dataValue('form.ANCs.refer_for_anc')
            ),
            field('ANC_referral_date__c', dataValue('form.ANCs.refer_anc')),
            field(
              'Mother_Skilled_Delivery_Referral__c',
              dataValue(
                'form.ANCs.pregnancy_danger_signs.refer_skilled_delivery'
              )
            ),
            field(
              'Mother_skilled_Ref_date__c',
              dataValue(
                'form.ANCs.pregnancy_danger_signs.refer_skilled_delivery1'
              )
            ),
            field(
            ...
            field(
              ...
              dataValue(
                'form.did_you_refer_for_hiv_counselling_and_testing_htc'
              )
            ),
            field(
            ...
            field(
              ...
              dataValue(
                'form.TT5.Child_Information.Nutrition2.date_malnutrition'
              )
            ),
            field(
            ...
            field('Childs_chest_indrawing_followup__c', state => {
              var choice = dataValue(
                'form.psbi.Childs_chest_indrawing_followup_c'
              )(state);
      ...
      console.log(
        'None of the ifs matched, skipping upsert and returning state.'
      );
      return state;
    }),
      ...
      if (
        ...
        return upsert(
          ...
          fields(
            ...
            field('Date__c', state => {
              var date = dataValue('form.TT5.Child_Information.ANCs.ANC_1')(
                state
              );
      ...
      if (
        ...
        return upsert(
          ...
          fields(
            ...
            field('Date__c', state => {
              var date = dataValue('form.TT5.Child_Information.ANCs.ANC_2')(
                state
              );
      ...
      if (
        ...
        return upsert(
          ...
          fields(
            ...
            field('Date__c', state => {
              var date = dataValue('form.TT5.Child_Information.ANCs.ANC_3')(
                state
              );
      ...
      if (
        ...
        return upsert(
          ...
          fields(
            ...
            field('Date__c', state => {
              var date = dataValue('form.TT5.Child_Information.ANCs.ANC_4')(
                state
              );
      ...
      if (
        ...
        return upsert(
          ...
          fields(
            ...
            field('Date__c', state => {
              var date = dataValue('form.TT5.Child_Information.ANCs.ANC_5')(
                state
              );
    ...
    fn(state => {
      if (
        dataValue('form.treatment_and_tracking.malaria_test')(state) === 'yes'
      ) {
        return upsert(
          'Service__c',
          'Service_UID__c',
    ...
    fn(state => {
      if (
        dataValue('form.treatment_and_tracking.symptoms_other_referral')(
          state
        ) == 'yes'
      ) {
        return upsert(
    ...
    fn(state => {
      if (
        dataValue('form.TT5.Child_Information.Nutrition2.Referral')(state) ===
        'yes'
      ) {
        return upsert(
          'Service__c',
    ...
    fn(state => {
      if (
        dataValue('form.treatment_and_tracking.TB_referral')(state) === 'yes'
      ) {
        return upsert(
          'Service__c',
          'Service_UID__c',
    ...
    fn(state => {
      if (
        dataValue('form.treatment_and_tracking.diarrhea_referral')(state) ===
        'yes'
      ) {
        return upsert(
          'Service__c',
    ...
    fn(state => {
      if (
        dataValue('form.treatment_and_tracking.malaria_referral')(state) ===
        'yes'
      ) {
        return upsert(
          'Service__c',
        ...
        return beta.each(
          ...
          upsert(
            ...
            fields(
              ...
              field(
                'Clinic_Zinc__c',
                dataValue('diarrhea_clinic_treatment_zinc')
              ),
              field(
                'Clinic_ORS__c',
                dataValue('diarrhea_clinic_treatment_ORS')
              ),
              relationship('Site__r', 'Label__c', state => {
    ...
    fn(state => {
      if (
        dataValue('form.psbi.did_you_refer_the_child_for_fast_breathing')(
          state
        ) === 'yes'
      ) {
        return upsert(
