...
combine(function(state){
  ...
  //ANC1
combine( function(state) {
  if(dataValue("$.form.TT5.Child_Information.ANCs.copy-1-of-anc_1")(state)=="click_to_enter_anc_1"){ //Q: Change this criteria??
...
combine( function(state) {
  ...
  //BCG REVIEWED
combine( function(state) {
  if(dataValue("$.form.TT5.Child_Information.Immunizations.BCG_h")(state)!==null){
    create("Service__c", fields(
      field("Source__c",1),
      field("Reason_for_Service__c","BCG"),
      field("Household_CHW__c",dataValue("$.form.CHW_ID_Final")),
      field("Date__c",dataValue("$.form.TT5.Child_Information.Immunizations.BCG_h")), //WAS `BCG` - did q name change?
      field("Type_of_Service__c","CHW Mobile Survey"),
      field("RecordTypeID","01224000000YAuK"),
      relationship("Person__r","CommCare_ID__c",dataValue("$.form.case.@case_id")),
      relationship("Site__r","Label__c",function(state){
  ...
  //OPV0 REVIEWED
combine( function(state) {
  if(dataValue("$.form.TT5.Child_Information.Immunizations.OPV0_h")(state)!==null){
    create("Service__c", fields(
      field("Source__c",1),
      field("Reason_for_Service__c","OPV0"),
      field("Household_CHW__c",dataValue("$.form.CHW_ID_Final")),
      field("Date__c",dataValue("$.form.TT5.Child_Information.Immunizations.OPV0_h")),
      field("Type_of_Service__c","CHW Mobile Survey"),
      field("RecordTypeID","01224000000YAuK"),
      relationship("Person__r","CommCare_ID__c",dataValue("$.form.case.@case_id")),
      relationship("Site__r","Label__c",function(state){
  ...
  //OPV1 REVIEWED
combine( function(state) {
  if(dataValue("$.form.TT5.Child_Information.Immunizations.OPV1_h")(state)!==null){
    create("Service__c", fields(
      field("Source__c",1),
      field("Reason_for_Service__c","OPV1"),
      field("Household_CHW__c",dataValue("$.form.CHW_ID_Final")),
      field("Date__c",dataValue("$.form.TT5.Child_Information.Immunizations.OPV1_h")),
      field("Type_of_Service__c","CHW Mobile Survey"),
      field("RecordTypeID","01224000000YAuK"),
      relationship("Person__r","CommCare_ID__c",dataValue("$.form.case.@case_id")),
      relationship("Site__r","Label__c",function(state){
  ...
  //OPV2
combine( function(state) {
  if(dataValue("$.form.TT5.Child_Information.Immunizations.OPV2_h")(state)!==null){
    create("Service__c", fields(
      field("Source__c",1),
      field("Reason_for_Service__c","OPV2"),
      field("Household_CHW__c",dataValue("$.form.CHW_ID_Final")),
      field("Date__c",dataValue("$.form.TT5.Child_Information.Immunizations.OPV2_h")),
      field("Type_of_Service__c","CHW Mobile Survey"),
      field("RecordTypeID","01224000000YAuK"),
      relationship("Person__r","CommCare_ID__c",dataValue("$.form.case.@case_id")),
      relationship("Site__r","Label__c",function(state){
  ...
  //OPV3
combine( function(state) {
  if(dataValue("$.form.TT5.Child_Information.Immunizations.OPV3_h")(state)!==null){
    create("Service__c", fields(
      field("Source__c",1),
      field("Reason_for_Service__c","OPV3"),
      field("Household_CHW__c",dataValue("$.form.CHW_ID_Final")),
      field("Date__c",dataValue("$.form.TT5.Child_Information.Immunizations.OPV3_h")),
      field("Type_of_Service__c","CHW Mobile Survey"),
      field("RecordTypeID","01224000000YAuK"),
      relationship("Person__r","CommCare_ID__c",dataValue("$.form.case.@case_id")),
      relationship("Site__r","Label__c",function(state){
  ...
  //Measles 6
combine( function(state) {
  if(dataValue("$.form.TT5.Child_Information.Immunizations.Measles6_h")(state)!==null){
    create("Service__c", fields(
      field("Source__c",1),
      field("Reason_for_Service__c","Measles 6"),
      field("Household_CHW__c",dataValue("$.form.CHW_ID_Final")),
      field("Date__c",dataValue("$.form.TT5.Child_Information.Immunizations.Measles6_h")),
      field("Type_of_Service__c","CHW Mobile Survey"),
      field("RecordTypeID","01224000000YAuK"),
      relationship("Person__r","CommCare_ID__c",dataValue("$.form.case.@case_id")),
      relationship("Site__r","Label__c",function(state){
  ...
  //Measles 9
combine( function(state) {
  if(dataValue("$.form.TT5.Child_Information.Immunizations.Measles9_h")(state)!==null){
    create("Service__c", fields(
      field("Source__c",1),
      field("Reason_for_Service__c","Measles 9"),
      field("Household_CHW__c",dataValue("$.form.CHW_ID_Final")),
      field("Date__c",dataValue("$.form.TT5.Child_Information.Immunizations.Measles9_h")),
      field("Type_of_Service__c","CHW Mobile Survey"),
      field("RecordTypeID","01224000000YAuK"),
      relationship("Person__r","CommCare_ID__c",dataValue("$.form.case.@case_id")),
      relationship("Site__r","Label__c",function(state){
...
//Measles 18
combine( function(state) {
  if(dataValue("$.form.TT5.Child_Information.Immunizations.Measles18_h")(state)!==null){
    create("Service__c", fields(
      field("Source__c",1),
      field("Reason_for_Service__c","Measles 18"),
      field("Household_CHW__c",dataValue("$.form.CHW_ID_Final")),
      field("Date__c",dataValue("$.form.TT5.Child_Information.Immunizations.Measles18_h")),
      field("Type_of_Service__c","CHW Mobile Survey"),
      field("RecordTypeID","01224000000YAuK"),
      relationship("Person__r","CommCare_ID__c",dataValue("$.form.case.@case_id")),
      relationship("Site__r","Label__c",function(state){
