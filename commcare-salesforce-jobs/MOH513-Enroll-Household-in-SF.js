        ...
        upsert(
          ...
          fields(
            ...
            field('Relation_to_the_head_of_the_household__c', state => {
              var relation = dataValue('Basic_Information.relation_to_hh')(
                state
              );
              var toTitleCase =
                relation !== undefined
            ...
            field('Active_in_HAWI__c', state => {
              var status = dataValue(
                'Basic_Information.person_info.hiv_status'
              )(state);
            ...
            field('Child_Status__c', state => {
              ...
              var status = dataValue('Basic_Information.Child_Status')(state);
              return dob !== undefined || status == 'Born' || status == 'Unborn'
                ? status
                : null; //what about deceased?
            }),
            ...
            field('Disability__c', state => {
              ...
              disability && disability.includes('none')
