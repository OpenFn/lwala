fn(state => {
  ...
  const queries = caseTypes.map(
    ...
    //t => `?type=${t}&indexed_on_start=2023-03-01T00:00:00&limit=${limit}&indexed_on_end=2023-03-03T00:00:00` //returns 14 records
    t => `?type=${t}&indexed_on_start=2023-03-01T00:00:00&limit=${limit}&indexed_on_end=2023-03-01T22:00:00`
  );
