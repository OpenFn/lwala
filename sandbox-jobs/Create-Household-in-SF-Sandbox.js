    ...
    if (dataValue('$.form.Person[0]') !== undefined) {
      each(
        ...
        field("Active_in_HAWI__c",function(state){
          if(dataValue("$.form.Basic_Information.HAWI_Status")(state)=="Yes"){
            ...
            field(
              'BCG__c',
              dataValue('TT5.Child_Information.Immunizations.BCG')
            ),
            field(
              'OPV_0__c',
            ...
            field(
              'Child_Status__c',
              dataValue('Basic_Information.Child_Status')
            ),
      ...
      create(
        ...
        fields(
          field(
            'Name',
            dataValue('$.form.Person.Basic_Information.Person_Name')
          ),
          relationship('RecordType', 'Name', function (state) {
            return dataValue('$.form.Person.Basic_Information.Record_Type')(
              state
            )
              .toString()
              .replace(/_/g, ' ');
          ...
          field(
            'Next_of_Kin__c',
            dataValue(
              '$.form.Person.Basic_Information.Contact_Info.Next_of_Kin'
            )
          ),
          field(
            'Next_of_Kin_Phone__c',
          ...
          field('Pregnant__c', function (state) {
            if (
              dataValue('$.form.Person.TT5.Mother_Information.Pregnant')(
                state
              ) == 'Yes'
            )
              return 1;
          ...
          field('Education_Level__c', function (state) {
            if (
              dataValue('$.form.Person.Basic_Information.Record_Type')(
                state
              ) !== 'Child' &&
              dataValue('$.form.Person.Basic_Information.Record_Type')(
                state
          ...
          field('Preferred_Care_Facility__c', function (state) {
            ...
            if (
              ...
              val = dataValue('$.form.Person.HAWI.Preferred_Care_Facility')(
                state
              )
                .toString()
                .replace(/_/g, ' ');
